...
HD_PWD='C:/Users/aptsi/Desktop/MIPS_single_cycle_processor/MIPS_single_cycle_processor.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log MIPS_single_cycle_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPS_single_cycle_processor.tcl
