...
HD_PWD='C:/Users/aptsi/Desktop/MIPS_single_cycle_processor/MIPS_single_cycle_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS_single_cycle_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPS_single_cycle_processor.tcl -notrace
